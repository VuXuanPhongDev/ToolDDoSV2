#[+]==============[ Contact ]=========================[+]#
# # Github    : Github.com/VuXuanPhongXDeveloper                     # #
# # Email  : vuxxanphong.x.developer@gmail.com          # #
#[+]==================================================[+]#
 ...
 \   Y   /  |  \  \     /|  |  \__  \  /    \   |     ___/  |  \ /  _ \ /    \  / ___\ 
  \     /|  |  /  /     \|  |  // __ \|   |  \  |    |   |   Y  (  <_> )   |  \/ /_/  >
   \___/ |____/  /___/\  \____/(____  /___|  /  |____|   |___|  /\____/|___|  /\___  / 
                       \_/          \/     \/                 \/            \//_____/  
Tool ddos chống bị vào tù by Vu Xuan Phong dz =)))) ( nếu dùng link thì chọn 1-4 còn nếu ip thì 5-6) ''')
    try:
